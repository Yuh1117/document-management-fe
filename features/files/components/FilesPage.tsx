...
const Files = ({ mode, initialItems }: { mode: string; initialItems?: IFileItem[] }) => {
  const { t } = useTranslation()

  let page: React.ReactNode
  switch (mode) {
    case 'my-files':
      page = <MyFilesPage initialItems={initialItems} />
      break
    case 'search':
      page = <SearchFilesPage />
      break
    case 'folder':
      page = <FolderFilesPage initialItems={initialItems} />
      break
    case 'shared':
      page = <SharedFilesPage initialItems={initialItems} />
      break
    case 'recent':
      page = <RecentFilesPage initialItems={initialItems} />
      break
    case 'trash':
      page = <TrashFilesPage initialItems={initialItems} />
      break
    default:
