...
const Login = () => {
  ...
  const [successMsg] = useState<string | null>(() => {
    ...
    if (msg) sessionStorage.removeItem('loginSuccessMsg')
    return msg
  })
            ...
            <form className="p-1" onSubmit={form.handleSubmit(onSubmit)}>
              <div className="flex flex-col gap-6">
                <div className="flex flex-col items-center text-center gap-1">
                  ...
                  <p className="text-muted-foreground text-balance">{t('login.title')}</p>
                </div>
                ...
                <div className="text-center text-sm">
                  {t('login.no_account') + ' '}
                  <Link href={'/signup'}>
                    <span className="underline underline-offset-4">{t('login.signup')}</span>
                  </Link>
                </div>
              </div>
            </form>
