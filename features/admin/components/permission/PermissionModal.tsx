...
import { ALL_METHODS, ALL_MODULES } from '@/constants/permissions'
...
const PermissionModal = ({ open, onOpenChange, isEditing, data, loadPermissions }: Props) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-full md:max-w-2xl" aria-describedby={undefined}>
        <DialogHeader>
          <DialogTitle>
            {isEditing ? t('admin.permission_title_edit') : t('admin.permission_title_add')}
          </DialogTitle>
        </DialogHeader>
        {msg && (
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      >
                        <FormControl>
                          <SelectTrigger
                            className={`w-full ${form.formState.errors.module ? 'border-red-500' : ''}`}
                          >
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      >
                        <FormControl>
                          <SelectTrigger
                            className={`w-full ${form.formState.errors.method ? 'border-red-500' : ''}`}
                          >
