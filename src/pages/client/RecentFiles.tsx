...
import DocumentDetail from "@/components/client/document/DocumentDetail";
import DocumentModal from "@/components/client/document/DocumentModal";
import Folder from "@/components/client/folder/Folder";
import FolderDetail from "@/components/client/folder/FolderDetail";
import FolderModal from "@/components/client/folder/FolderModal";
import { useFilesLoader } from "@/hooks/useFilesLoader";
import { useMultiSelect } from "@/hooks/useMultiSelect";
import { useDownloadFiles } from "@/hooks/useDownloadFiles";
import ShareUrlModal from "@/components/client/document/ShareUrlModal";
...
import DocumentVersionModal from "@/components/client/document/DocumentVersionModal";
...
const RecentFilesPage = () => {
    ...
    const { files, loading, hasMore, observerRef } = useFilesLoader(endpoints["recent-files"], fileState.reloadFlag);
        ...
        <div className="bg-muted dark:bg-muted flex flex-col rounded-xl p-2 select-none">
            ...
            <div className="bg-muted/60 backdrop-blur flex items-center justify-between rounded-xl p-4 border-b">
                <div className="flex items-center gap-4">
                    <SidebarTrigger />
                    <h1 className="text-2xl font-semibold">Files gần đây</h1>
                </div>
                <div
